...
// FIX 1: Add 'slug: string' to the product prop definition
export default function PurchaseBox({ product }:{ product:{
    id:string; name:string; slug: string; priceUGX:number; images:{url:string}[]; variants:Variant[]
}}){
...
            variantId: vid,
            name: product.name,
            // FIX 2: Pass the required 'slug' property
            slug: product.slug,
